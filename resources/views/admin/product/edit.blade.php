                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="sm:flex sm:items-center">
                        ...
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            <livewire:inventory-item-form  :item="null" :inventory="$inventory" :product="$inventory->product" />
                            {{--<livewire:admin.product.partials.item-form :item="null" :inventory="$inventory" :product="$inventory->product" />--}}
                            {{--<x-primary-button @click="open = true">
                                {{ __('Add Item') }}
                            </x-primary-button>
                            <div class="relative isolate z-50" role="dialog" aria-modal="true">
                                <div
                                    x-show="open"
                                    ...
                                    <div x-show="open" class="absolute inset-0 overflow-hidden">
                                        <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                                            <div
                                                ...
                                                class="pointer-events-auto relative isolate w-screen max-w-md"
                                                style="display: none"
                                            >
                                                <div
                                                    x-show="open"
