                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tr>
                                    ...
                                    <td class="flex justify-end whitespace-nowrap px-2 py-2 text-sm text-gray-500">
                                        <div class="flex-shrink flex items-center justify-end bg-indigo-500 rounded-md overflow-hidden">
                                            <button class="px-2 py-2 h-full text-white font-semibold hover:bg-indigo-700">-</button>
                                            <x-text-input class="text-sm w-10 h-full py-0 text-center" value="{{ 1 }}" />
                                            <button class="px-2 py-2 h-full text-white font-semibold hover:bg-indigo-700">+</button>
                                        </div>
                                    </td>
                                </tr>
