                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <x-dropdown width="48">
                            <x-slot name="trigger">
                                <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <div class="hidden lg:flex lg:items-center">
                                        <div class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">
                                            {{ auth()->user()->name }}
                                        </div>
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link href="{{ route('profile.edit') }}" class="" role="menuitem" tabindex="-1" id="user-menu-item-0">
                                    Your profile
                                </x-dropdown-link>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <x-dropdown-button class="" role="menuitem" tabindex="-1" id="user-menu-item-1">
                                        Sign out
                                    </x-dropdown-button>
                                </form>
                            </x-slot>
